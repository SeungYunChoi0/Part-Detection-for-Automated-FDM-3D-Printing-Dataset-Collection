#!/usr/bin/env python3
"""
RGB-based Yellow Batch Cropping Script (No HSV conversion)
RGB 기반 노란색 출력물 일괄 크로핑 스크립트
...
# 설정
# ============================================================
INPUT_DIR = Path('/Volumes/Yun_ssd/Modulino_CV/yellow/dataset_norm_yellow')
OUTPUT_DIR = Path('/Volumes/Yun_ssd/Modulino_CV/dataset_cropped_yellow_RGB')
...
LOWER_YELLOW_RGB = np.array([0, 150, 100])      # [B_low, G_high, R_high]
UPPER_YELLOW_RGB = np.array([150, 255, 255])    # [B_low, G_high, R_high]
...
# 출력물 검출 함수 (RGB 기반)
# ============================================================
def detect_yellow_part(img):
    """
    노란색 출력물 검출 (RGB 기반, HSV 변환 없음)
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    mask = cv2.inRange(img, LOWER_YELLOW_RGB, UPPER_YELLOW_RGB)
...
def process_images():
    ...
    print(f"RGB 임계값: LOWER={LOWER_YELLOW_RGB}, UPPER={UPPER_YELLOW_RGB}")
    print(f"{'='*60}\n")
    ...
    with open(LOG_FILE, 'w') as f:
        ...
        f.write(f"RGB Range: LOWER={LOWER_YELLOW_RGB}, UPPER={UPPER_YELLOW_RGB}\n")
        f.write("="*60 + "\n\n")
