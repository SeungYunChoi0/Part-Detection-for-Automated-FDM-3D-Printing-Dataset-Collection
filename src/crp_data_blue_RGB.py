#!/usr/bin/env python3
"""
RGB-based Blue Batch Cropping Script (No HSV conversion)
RGB 기반 파란색 출력물 일괄 크로핑 스크립트
...
OUTPUT_DIR = Path('/Volumes/Yun_ssd/Modulino_CV/data_cropped_blue_RGB')
...
# RGB 색상 범위 (파란색)
# ============================================================
# Blue in RGB: Low R, Low-Medium G, High B
# OpenCV uses BGR order!
LOWER_BLUE_RGB = np.array([150, 0, 0])      # [B_high, G_low, R_low]
UPPER_BLUE_RGB = np.array([255, 150, 100])  # [B_high, G_med, R_low]
...
# 출력물 검출 함수 (RGB 기반)
# ============================================================
def detect_blue_part(img):
    """
    파란색 출력물 검출 (RGB 기반, HSV 변환 없음)
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    mask = cv2.inRange(img, LOWER_BLUE_RGB, UPPER_BLUE_RGB)
...
def process_images():
    ...
    print(f"RGB 임계값: LOWER={LOWER_BLUE_RGB}, UPPER={UPPER_BLUE_RGB}")
    print(f"{'='*60}\n")
    ...
    with open(LOG_FILE, 'w') as f:
        ...
        f.write(f"RGB Range: LOWER={LOWER_BLUE_RGB}, UPPER={UPPER_BLUE_RGB}\n")
        f.write("="*60 + "\n\n")
    ...
    print(f"   ⚠️ Blue는 조명 변화에 특히 민감할 수 있음")
...
if __name__ == "__main__":
    try:
        ...
        if stats['total'] > 0 and (stats['success'] / stats['total']) < 0.9:
            ...
            print("   Blue는 낮은 V-channel로 인해 RGB에서 더 어려울 수 있습니다.")
