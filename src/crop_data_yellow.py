...
# 설정
# ============================================================
INPUT_DIR = Path('/Volumes/Yun_ssd/Modulino_CV/dataset_norm_yellow')
OUTPUT_DIR = Path('/Volumes/Yun_ssd/Modulino_CV/dataset_cropped_yellow')
...
def process_images():
    ...
    print(f"성공: {stats['success']}개 ({stats['success']/total_images*100:.1f}%)")
