#!/usr/bin/env python3
"""
Pipeline Visualization for Pink Filament
4-Stage Visualization: Input → HSV Mask → Spatial Filtering → Output

Key Feature: Sticker region exclusion (lower-right quadrant)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# HSV Parameters for Pink
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
LOWER_PINK = np.array([140, 50, 60])
...
# Pink-specific: Sticker Exclusion
STICKER_X_MIN = 0.65  # Right 35%
STICKER_Y_MIN = 0.65  # Bottom 35%
STICKER_MAX_AREA = 5000
STICKER_MAX_ASPECT = 1.8
...
def visualize_pipeline(input_path, output_dir):
    ...
    for i, contour in enumerate(contours):
        ...
        # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        # Pink-specific: Sticker Exclusion (Lower-Right)
        # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        in_sticker_area = (x > width * STICKER_X_MIN and 
                           y > height * STICKER_Y_MIN)
        
        is_small = (area < STICKER_MAX_AREA)
        is_square_like = (aspect_ratio < STICKER_MAX_ASPECT)
        
        if in_sticker_area and is_small and is_square_like:
            rejected_objects.append({
                'bbox': (x, y, w, h),
                'reason': 'Sticker Region'
            })
            continue
    ...
    if len(valid_objects) > 0:
        ...
        # Draw all valid objects (magenta)
        for obj in valid_objects:
            if obj == selected_obj:
                continue
            x, y, w, h = obj['bbox']
            cv2.rectangle(img_bbox, (x, y), (x+w, y+h), (255, 0, 255), 2)  # Magenta
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python visualize_pipeline_pink.py <input_image> [output_dir]")
        print("\nExample:")
        print("  python visualize_pipeline_pink.py input.jpg visualization_pink/")
        print("\nPink-specific features:")
        print("  - Sticker region exclusion (lower-right X>65%, Y>65%)")
        print("  - Small square sticker detection (area<5000, aspect<1.8)")
        sys.exit(1)
    
    input_path = sys.argv[1]
    output_dir = sys.argv[2] if len(sys.argv) > 2 else "./visualization_pink"
